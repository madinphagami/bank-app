...
- Smooth hover transitions and consistent color palette
...
- **Design Source:** [Figma]([https://vercel.com](https://www.figma.com/community/file/1498087976362579412/trustworthy-app-download)
...
```bash
git clone https://github.com/<your-username>/etran-portfolio.git
cd etran-portfolio
npm install
npm run dev
```
